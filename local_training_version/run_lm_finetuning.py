...
def main():
    ...
    if args.do_train:
        ...
        # choose JSON-based contrastive dataset or the original XML loader
        if args.use_json_contrastive:
            from preprocessing.json_contrastive_dataset import JsonContrastiveDataset
            train_dataset = JsonContrastiveDataset(
                json_dir=os.path.join(args.data_dir, 'demosthenes_training_json'),
                tokenizer=tokenizer,
                args=args
            )
        else:
