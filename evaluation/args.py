...
def get_parser(parser_type, model_classes=None, all_models=None):
    ...
    if parser_type == "finetuning":
        ...
        parser.add_argument('--use_json_contrastive', action='store_true',
                            help="Load training examples from JSON contrastive files instead of XML dataset.")
        parser.add_argument('--max_seq_length', default=128, type=int,
                            help="Max sequence length for prefix/positive tokenization.")
